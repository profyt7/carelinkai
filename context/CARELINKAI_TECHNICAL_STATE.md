...
_Last updated: 2026-06-28 — OL-105 CLOSED (#673): schema-drift fixed (PlacementSearch/Request + DISCHARGE_PLANNER enum baseline migrations 20260628000002/3) + concierge e2e/unit tests (e2e-concierge job). DP-free marketing/signup (#674); DP card polish + post-signup verify UX (#675). OL-104: in-app DP concierge flow (#671). Claim-admin alert → chris@ + Reply-To (#670). Prior: OL-103 money-path/DP-billing (#665–#668, closes OL-055); OL-102 parked (placement-fee); OL-101 DP-free (#659)_
