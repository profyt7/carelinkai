...
_Last updated: 2026-06-28 — OL-104: in-app DP concierge placement flow (#671, migration 20260628000001). Claim-admin alert → chris@ + Reply-To on operator outreach (#670). OL-105 OPEN: PlacementSearch/Request schema drift (no creating migration; stopgap-guarded). Prior: OL-103 money-path/DP-billing (#665–#668, closes OL-055); OL-102 parked (placement-fee); OL-101 DP-free (#659)_
