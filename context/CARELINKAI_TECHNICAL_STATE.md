...
_Last updated: 2026-06-27 — OL-100: lead-funnel (#654–#657) — tour→claim nudge, claimed-op email, family fallback, per-facility email-only claim drip (migration 20260627000002, GHA cron). Prior: OL-099 enrichment + reviews_
