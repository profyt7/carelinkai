...
### OL-114: TCPA/marketing lead-consent capture on family-facing forms
- **Status:** 🟢 BUILT 2026-07-04 (branch `feat/lead-consent-capture`) — capture infrastructure ONLY; nothing is sold or sent today. **Residual: attorney review of the v1 copy** (below).
