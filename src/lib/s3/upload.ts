...
// HIPAA: uses AWS_S3_* env vars exclusively per Phase 1 standardization.
// See HIPAA_PHASE_1_DESIGN.md §4
...
export async function generatePresignedUrl(
  ...
  const bucketName = process.env['AWS_S3_BUCKET']; // AWS_S3_* standard
