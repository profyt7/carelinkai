...
export const MOCK_CAREGIVERS: Caregiver[] = [
  { id: "cg_1", name: "Ava Johnson", city: "Seattle", state: "WA", hourlyRate: 28, yearsExperience: 5, specialties: ["dementia","medication-management","companionship"], bio: "Experienced caregiver focused on dignity and independence.", photoUrl: "https://randomuser.me/api/portraits/women/47.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 2.3 },
  { id: "cg_2", name: "Noah Williams", city: "Bellevue", state: "WA", hourlyRate: 25, yearsExperience: 3, specialties: ["companionship"], bio: "Friendly and reliable with flexible evenings/weekends.", photoUrl: "https://randomuser.me/api/portraits/men/32.jpg", backgroundCheckStatus: "PENDING", distanceMiles: 7.8 },
  { id: "cg_3", name: "Sophia Martinez", city: "Redmond", state: "WA", hourlyRate: 32, yearsExperience: 7, specialties: ["memory-care","dementia"], bio: "Memory care specialist with a calm, supportive approach.", photoUrl: "https://randomuser.me/api/portraits/women/65.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 12.1 },
  { id: "cg_4", name: "Liam Smith", city: "Kirkland", state: "WA", hourlyRate: 27, yearsExperience: 4, specialties: ["companionship","mobility"], bio: "Patient and attentive, great with mobility support.", photoUrl: "https://randomuser.me/api/portraits/men/15.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 5.2 },
  { id: "cg_5", name: "Olivia Brown", city: "Tacoma", state: "WA", hourlyRate: 29, yearsExperience: 6, specialties: ["medication-management","companionship"], bio: "Medication reminders and compassionate companionship.", photoUrl: "https://randomuser.me/api/portraits/women/33.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 28.6 },
  { id: "cg_6", name: "Ethan Davis", city: "Lynnwood", state: "WA", hourlyRate: 24, yearsExperience: 2, specialties: ["companionship"], bio: "Great conversationalist, enjoys walks and board games.", photoUrl: "https://randomuser.me/api/portraits/men/51.jpg", backgroundCheckStatus: "PENDING", distanceMiles: 14.4 },
  { id: "cg_7", name: "Mia Garcia", city: "Renton", state: "WA", hourlyRate: 31, yearsExperience: 8, specialties: ["alzheimers","medication-management"], bio: "Alzheimer's experience with focus on routines and safety.", photoUrl: "https://randomuser.me/api/portraits/women/12.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 10.9 },
  { id: "cg_8", name: "James Miller", city: "Seattle", state: "WA", hourlyRate: 26, yearsExperience: 3, specialties: ["transportation","companionship"], bio: "Safe driver with reliable transportation.", photoUrl: "https://randomuser.me/api/portraits/men/7.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 3.9 },
  { id: "cg_9", name: "Charlotte Wilson", city: "Bellevue", state: "WA", hourlyRate: 33, yearsExperience: 9, specialties: ["wound-care","medication-management"], bio: "Clinical background with wound care experience.", photoUrl: "https://randomuser.me/api/portraits/women/88.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 8.7 },
  { id: "cg_10", name: "Benjamin Moore", city: "Issaquah", state: "WA", hourlyRate: 23, yearsExperience: 2, specialties: ["companionship"], bio: "College student caregiver with flexible hours.", photoUrl: "https://randomuser.me/api/portraits/men/43.jpg", backgroundCheckStatus: "PENDING", distanceMiles: 18.2 },
  { id: "cg_11", name: "Amelia Taylor", city: "Shoreline", state: "WA", hourlyRate: 30, yearsExperience: 6, specialties: ["medication-management","mobility"], bio: "Detail-oriented caregiver, strong communication.", photoUrl: "https://randomuser.me/api/portraits/women/22.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 9.4 },
  { id: "cg_12", name: "Lucas Anderson", city: "Seattle", state: "WA", hourlyRate: 34, yearsExperience: 10, specialties: ["dementia","alzheimers"], bio: "Decade of experience in memory care settings.", photoUrl: "https://randomuser.me/api/portraits/men/60.jpg", backgroundCheckStatus: "CLEAR", distanceMiles: 1.8 },
];
...
export const MOCK_PROVIDERS: Provider[] = [
  { id: "pr_1", name: "CarePlus Transport", city: "Seattle", state: "WA", services: ["transportation"], hourlyRate: 40, perMileRate: 1.5, ratingAverage: 4.7, reviewCount: 58, badges: ["Licensed","Insured"], distanceMiles: 4.2, description: "Non-emergency medical transportation across King County.", coverageRadius: 30, availableHours: "Mon–Sun 6am–10pm", photoUrl: "https://randomuser.me/api/portraits/men/25.jpg" },
  { id: "pr_2", name: "Comfort Meals Co.", city: "Redmond", state: "WA", services: ["meal-prep","housekeeping"], hourlyRate: 35, perMileRate: null, ratingAverage: 4.5, reviewCount: 31, badges: ["Background Checked"], distanceMiles: 11.3, description: "Healthy meal preparation and light housekeeping.", coverageRadius: 20, availableHours: "Mon–Fri 8am–6pm", photoUrl: "https://randomuser.me/api/portraits/women/44.jpg" },
  { id: "pr_3", name: "CityCare Housekeeping", city: "Seattle", state: "WA", services: ["housekeeping"], hourlyRate: 30, perMileRate: null, ratingAverage: 4.3, reviewCount: 22, badges: ["Insured"], distanceMiles: 5.6, description: "Home cleaning tailored for seniors.", coverageRadius: 25, availableHours: "Mon–Sat 8am–5pm", photoUrl: "https://randomuser.me/api/portraits/women/33.jpg" },
  { id: "pr_4", name: "Northwest Rides", city: "Bellevue", state: "WA", services: ["transportation"], hourlyRate: 42, perMileRate: 1.7, ratingAverage: 4.6, reviewCount: 40, badges: ["Licensed"], distanceMiles: 9.0, description: "Comfortable wheelchair-accessible vans.", coverageRadius: 35, availableHours: "Mon–Sun 7am–9pm", photoUrl: "https://randomuser.me/api/portraits/men/58.jpg" },
  { id: "pr_5", name: "HomeChef Helpers", city: "Kirkland", state: "WA", services: ["meal-prep"], hourlyRate: 33, perMileRate: null, ratingAverage: 4.2, reviewCount: 15, badges: [], distanceMiles: 8.5, description: "Weekly meal plans and grocery assistance.", coverageRadius: 15, availableHours: "Mon–Fri 9am–5pm", photoUrl: "https://randomuser.me/api/portraits/women/71.jpg" },
  { id: "pr_6", name: "FreshStart Housekeeping", city: "Renton", state: "WA", services: ["housekeeping"], hourlyRate: 28, perMileRate: null, ratingAverage: 4.1, reviewCount: 18, badges: [], distanceMiles: 12.7, description: "Light housekeeping with attention to detail.", coverageRadius: 18, availableHours: "Mon–Sat 9am–4pm", photoUrl: "https://randomuser.me/api/portraits/women/22.jpg" },
  { id: "pr_7", name: "CareRide", city: "Shoreline", state: "WA", services: ["transportation"], hourlyRate: 39, perMileRate: 1.4, ratingAverage: 4.8, reviewCount: 65, badges: ["Licensed","Insured"], distanceMiles: 10.2, description: "On-time, caring transportation for seniors.", coverageRadius: 28, availableHours: "Mon–Sun 6am–8pm", photoUrl: "https://randomuser.me/api/portraits/men/41.jpg" },
  { id: "pr_8", name: "MealMates", city: "Lynnwood", state: "WA", services: ["meal-prep"], hourlyRate: 31, perMileRate: null, ratingAverage: 4.0, reviewCount: 12, badges: [], distanceMiles: 14.8, description: "Affordable home-cooked meals.", coverageRadius: 12, availableHours: "Mon–Fri 10am–6pm", photoUrl: "https://randomuser.me/api/portraits/men/16.jpg" },
];
