    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center py-12">
          <div className="text-neutral-600">Loading system health...</div>
        </div>
      </div>
    );
  }
        ...
        <>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-neutral-900 mb-2">Overall Status</h3>
              ...
              <div className="text-right">
                <div className="text-sm text-neutral-600">Last Check</div>
          ...
          {/* Database Health */}
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-lg font-semibold text-neutral-900 mb-4">Database Health</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {health.metrics.database.error && (
                <div className="col-span-full">
                  <div className="text-sm text-neutral-600 mb-1">Error</div>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <div className="text-sm text-neutral-600 mb-1">Database Response Time</div>
              ...
              <div>
                <div className="text-sm text-neutral-600 mb-1">Avg API Response Time</div>
          ...
          {/* Error Metrics */}
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-lg font-semibold text-neutral-900 mb-4">Error Metrics</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <div className="text-sm text-neutral-600 mb-1">Errors (Last 24h)</div>
                <div className="text-3xl font-bold text-error-600">
                  {health.metrics.errors.last24Hours}
                </div>
              </div>
              <div>
                <div className="text-sm text-neutral-600 mb-1">Error Rate</div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <div className="text-sm text-neutral-600 mb-1">Uptime Status</div>
              ...
              <div>
                <div className="text-sm text-neutral-600 mb-1">Last Deployment</div>
                <div className="text-sm font-medium text-neutral-900">
...
function StatCard({ 
  ...
  const colorClasses = {
    ...
    orange: 'bg-warning-50 border-warning-200',
  }[color];

  return (
    <div className={`${colorClasses} border rounded-lg p-4`}>
      <div className="text-sm text-neutral-600 mb-1">{title}</div>
      {subtitle && <div className="text-xs text-neutral-500 mb-2">{subtitle}</div>}
      <div className="text-3xl font-bold text-neutral-900">{value.toLocaleString()}</div>
    </div>
  );
}
