...
// HIPAA: classification=PII (caregiver professional credentials), destination=S3
...
export async function POST(request: NextRequest) {
  try {
    ...
    captureError(error instanceof Error ? error : new Error(String(error)), { tags: { route: 'caregiver:credentials:upload-url' } });
