...
export default function Dashboard() {
  ...
  // Chart data for expenses donut chart
  const expensesChartData = {
    labels: mockData.expenses.breakdown.map(item => item.label),
    datasets: [
      {
        data: mockData.expenses.breakdown.map(item => parseFloat(item.value.replace(/[^0-9.-]+/g, ""))),
  ...
  // Chart data for placements line chart
    ...
    <DashboardLayout title="Dashboard">
      <div className="p-4 md:p-6">
        <div className="mb-6 flex flex-wrap items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-neutral-800">Welcome back, {displayName}</h2>
            <p className="text-neutral-500">Here's what's happening with your care home today</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <section className="dashboard-section col-span-1">
            ...
            <div className="card">
              <div className="text-2xl font-bold text-neutral-800 mb-4">{mockData.expenses.total}</div>
          ...
          <section className="dashboard-section col-span-1">
            ...
            <div className="card">
              <div className="mb-4">
                ...
                <p className="text-sm text-neutral-600">Accept resident payments with lower transaction fees</p>
              </div>
              ...
              <button className="btn btn-primary w-full">
                Get access to low fees
              </button>
              
              <div className="flex justify-center mt-4">
                <div className="flex space-x-1">
                  <button className="h-2 w-2 rounded-full bg-primary-500"></button>
                  <button className="h-2 w-2 rounded-full bg-neutral-300"></button>
                  <button className="h-2 w-2 rounded-full bg-neutral-300"></button>
                  <button className="h-2 w-2 rounded-full bg-neutral-300"></button>
                  <button className="h-2 w-2 rounded-full bg-neutral-300"></button>
                </div>
