    ...
    <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link href={`/operator/homes/${home.id}/analytics${operatorOverrideId ? `?operatorId=${operatorOverrideId}` : ''}`} className="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">
              Analytics
            </Link>
          ...
          <div className="lg:col-span-2 card">
            ...
            <div className="mt-3">
              {home.aiGeneratedDescription && (
                <div className="mb-3 inline-flex items-center px-2 py-1 bg-primary-50 border border-primary-200 rounded-md">
                  <svg className="w-4 h-4 text-primary-600 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                  <span className="text-xs font-medium text-primary-700">AI-Enhanced Profile</span>
                </div>
              )}
