    ...
    <div className="py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <FiHelpCircle className="mx-auto h-16 w-16 text-primary-600 mb-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
            <FiMail className="mx-auto h-8 w-8 text-primary-600 mb-3" />
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
            <FiPhone className="mx-auto h-8 w-8 text-primary-600 mb-3" />
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
            <FiMessageCircle className="mx-auto h-8 w-8 text-primary-600 mb-3" />
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="flex items-center mb-6">
            <FiBook className="h-6 w-6 text-primary-600 mr-3" />
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a 
              href="#" 
              className="flex items-center p-4 border border-neutral-200 rounded-lg hover:border-primary-600 hover:bg-primary-50 transition-colors"
            >
              <FiBook className="h-6 w-6 text-primary-600 mr-3" />
              <div>
                <h3 className="font-semibold text-neutral-900">User Guide</h3>
                <p className="text-sm text-neutral-600">Complete documentation</p>
              </div>
            </a>
            ...
            >
              <FiBook className="h-6 w-6 text-primary-600 mr-3" />
              <div>
                <h3 className="font-semibold text-neutral-900">Video Tutorials</h3>
                <p className="text-sm text-neutral-600">Step-by-step guides</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">For developers</p>
              </div>
            </a>
            ...
            >
              <FiBook className="h-6 w-6 text-primary-600 mr-3" />
              <div>
                <h3 className="font-semibold text-neutral-900">Release Notes</h3>
