    ...
    <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border-2 border-neutral-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full border-2 border-neutral-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 resize-none"
                />
              </div>
      ...
      {notes.length === 0 && !search ? (
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-12 text-center">
          <Edit3 className="w-12 h-12 text-neutral-400 mx-auto mb-3" />
          <p className="text-neutral-500">No notes found matching your search</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h3 className="font-bold text-lg text-neutral-900 group-hover:text-primary-600 transition-colors line-clamp-2">
                    {note.title}
                  </h3>
                </div>
                {!isGuest && (
              ...
              {note.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-4">
                  {note.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-gradient-to-r from-primary-100 to-cyan-50 text-xs font-semibold text-primary-800 border border-primary-200"
                    >
              ...
              <div className="flex items-center justify-between pt-3 border-t border-neutral-100 text-xs text-neutral-500">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-primary-500 to-cyan-400 flex items-center justify-center text-white font-bold text-[10px]">
