...
export default function MembersTab({ familyId, showMock = false, isGuest = false, currentUserRole }: MembersTabProps) {
  ...
  const roleColors = {
    OWNER: 'from-purple-100 to-pink-100 text-secondary-800 border-secondary-200',
    CARE_PROXY: 'from-primary-100 to-cyan-100 text-primary-800 border-primary-200',
    MEMBER: 'from-success-100 to-emerald-100 text-success-800 border-success-200',
    GUEST: 'from-gray-100 to-slate-100 text-neutral-800 border-neutral-200',
  };
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-neutral-900">Family Members</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border-2 border-neutral-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none"
                />
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-neutral-50 rounded-lg">
                ...
                <p className="text-xs text-neutral-500 mt-1">{selectedMember.user.email}</p>
              </div>

              <div>
                <label className="block text-sm font-semibold text-neutral-700 mb-2">
                  Current Role: <span className="text-primary-600">{selectedMember.role}</span>
                </label>
                <label className="block text-sm font-semibold text-neutral-700 mb-2 mt-4">
                  New Role
                </label>
                <select
                  value={newRole}
                ...
                <p className="text-xs text-neutral-500 mt-2">{roleDescriptions[newRole]}</p>
              </div>
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {members.map((member) => (
              <div
                key={member.id}
                className="group bg-white rounded-xl border border-neutral-200 p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-primary-300"
              >
                {/* Avatar and Info */}
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-cyan-400 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                ...
                {isOwner && (
                  <div className="flex gap-2 pt-3 border-t border-neutral-100">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 border border-primary-300 text-primary-600 rounded-lg hover:bg-primary-50 transition-colors text-xs font-semibold"
                    >
      ...
      {/* Role Legend */}
      <div className="mt-8 bg-gradient-to-r from-primary-50 to-cyan-50 rounded-xl border border-primary-200 p-6">
