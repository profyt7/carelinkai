  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <p className="ml-3 text-neutral-600">Loading communications...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-error-50 border border-error-200 rounded-lg p-4">
        <p className="text-error-800 font-medium">Error loading communications</p>
      ...
      <div className="space-y-4">
        {!responses || responses.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-neutral-600">No communications yet</p>
