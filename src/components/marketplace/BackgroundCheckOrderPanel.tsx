...
import { FiShield, FiCheck, FiLoader, FiChevronDown, FiChevronUp, FiTruck, FiStar, FiAlertCircle } from "react-icons/fi";
  ...
  const handleOrder = async () => {
    ...
    try {
      ...
      if (data.requiresPayment) {
        ...
        // For now show a clear message directing to payment
        setResult({ success: true, message: `${PACKAGES[selected].label} ordered — payment of $${PACKAGES[selected].price} will be processed. Results in ${PACKAGES[selected].turnaround}.` });
