...
|-----------------------|-----------|--------------------------------------------------|--------|--------------|
| Provider signup       | Provider  | Create account and log in                        | DONE   | API: /api/auth/register accepts PROVIDER and auto-creates Provider record. UI: /auth/register shows Provider option. Post-signup access to /settings/provider. |
...
| Provider search list  | Operator  | Browse/search list of providers                  | TODO   |              |
| Provider filters      | Operator  | Filter providers by location, service type, etc. | TODO   |              |
| Provider detail view  | Operator  | View provider profile, services, docs            | TODO   |              |
