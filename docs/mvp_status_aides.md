...
| Aide availability        | Aide      | Set/update availability (days/times)                | DONE   | Caregivers can manage weekly schedule at /settings/availability; backend GET/PATCH /api/caregiver/availability persists JSON { timezone, weekly:{mon..sun:[{start,end}] } }. Operator caregiver detail shows summary (e.g., “Mon–Fri 09:00–17:00”). |
...
| Aide detail view         | Operator  | View aide profile, skills, docs, availability       | WIP    | Detail shows photo, bio, rate, experience, specialties, reviews, hire request, and availability summary. No calendar view or docs listing surfaced. UI: /marketplace/caregivers/[id]. |
