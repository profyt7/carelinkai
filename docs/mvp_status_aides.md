...
| Operator ? Aide contact  | Operator  | Send an initial contact / message to aide           | DONE   | Message/Contact button deep-links to /messages?userId=<caregiverUserId>; creates or reuses conversation. |
